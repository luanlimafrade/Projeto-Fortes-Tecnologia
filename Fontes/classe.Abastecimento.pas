...
begin
  ...
  try
    ...
    begin
      close;
      sql.Clear;
      SQL.Add('select codigo, iif(bomba = 1,''Bomba 2'',''Bomba 1'')bomba, data, iif(tanque = 1, ''Óleo Diesel'',''Gasolina'')TANQUE, valor from abastecimento where data between :p_texto and :p_texto2');
